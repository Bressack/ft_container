...
#include "map/map.hpp"
#include "shared/tests.hpp"

template < typename T >
void print_stack_inf(T s)
{
  std::cout << "-----------" << std::endl;
  std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "size" << "  --------------------------" << C_RES << std::endl;
  std::cout << "size  : " << s.size() << std::endl;
  std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "empty" << "  --------------------------" << C_RES << std::endl;
  std::cout << "empty : " << s.empty() << std::endl;
  if (!s.empty())
  {
    std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "top" << "  --------------------------" << C_RES << std::endl;
    std::cout << "top   : " << s.top() << std::endl;
    s.top() -= 5;
    std::cout << "top   : " << s.top() << std::endl;
  }
  std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "push" << "  --------------------------" << C_RES << std::endl;
  s.push(8);
  s.push(16);
  std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "pop" << "  --------------------------" << C_RES << std::endl;
  s.pop();
  std::cout << "size  : " << s.size() << std::endl;
  std::cout << "-----------" << std::endl;
}
...
void  test_stack(void)
{
  ...
  std::cout << SKY_BLUE << "[[[[[[[[[[[[[[[[[[[[[[[[[[  " << std::left << std::setw(SW) << "BASICS INT" << "  ]]]]]]]]]]]]]]]]]]]]]]]]]]" << C_RES << std::endl;
  std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "constructor empty" << "  --------------------------" << C_RES << std::endl;
  NS::stack<int, std::deque<int> > first;                    // empty stack
  std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "constructor deque" << "  --------------------------" << C_RES << std::endl;
  NS::stack<int, std::deque<int> > second (mydeque);         // stack initialized to copy of deque

  std::cout << SKY_BLUE << "[[[[[[[[[[[[[[[[[[[[[[[[[[  " << std::left << std::setw(SW) << "BASICS VECTOR<INT>" << "  ]]]]]]]]]]]]]]]]]]]]]]]]]]" << C_RES << std::endl;
  ...
  std::cout << SKY_BLUE << "[[[[[[[[[[[[[[[[[[[[[[[[[[  " << std::left << std::setw(SW) << "BASICS <LIST>" << "  ]]]]]]]]]]]]]]]]]]]]]]]]]]" << C_RES << std::endl;
  ...
  std::cout << "size  : " << stack_list.size() << std::endl;
  std::cout << SKY_BLUE << "[[[[[[[[[[[[[[[[[[[[[[[[[[  " << std::left << std::setw(SW) << "const stack" << "  ]]]]]]]]]]]]]]]]]]]]]]]]]]" << C_RES << std::endl;
  const NS::stack<int,ft::vector<int> > sixth (myvector_const);
  print_stack_inf(sixth);

  std::cout << SKY_BLUE << "[[[[[[[[[[[[[[[[[[[[[[[[[[  " << std::left << std::setw(SW) << "RELATIONAL OPERATORS" << "  ]]]]]]]]]]]]]]]]]]]]]]]]]]" << C_RES << std::endl;
  std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "==" << "  --------------------------" << C_RES << std::endl;
...
void	test_vector_str(void)
{
	...
	std::cout << SKY_BLUE << "[[[[[[[[[[[[[[[[[[[[[[[[[[  " << std::left << std::setw(SW) << "BASICS" << "  ]]]]]]]]]]]]]]]]]]]]]]]]]]" << C_RES << std::endl;
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "constructor 1/4" << "  --------------------------" << C_RES << std::endl;
	NS::vector<std::string> first;                                // empty
	print_vector_inf_ptr(&first);
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "constructor 2/4" << "  --------------------------" << C_RES << std::endl;
	NS::vector<std::string> second (4, "hundred");                       // n, val (fill)
	print_vector_inf_ptr(&second);
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "constructor 3/4" << "  --------------------------" << C_RES << std::endl;
	NS::vector<std::string> fifth (second.begin() + 1,second.end());  // range
	print_vector_inf_ptr(&fifth);
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "constructor 4/4" << "  --------------------------" << C_RES << std::endl;
	NS::vector<std::string> third(second);                       // copy
	print_vector_inf_ptr(&third);
	std::cout << SKY_BLUE << "[[[[[[[[[[[[[[[[[[[[[[[[[[  " << std::left << std::setw(SW) << "MODIFIERS" << "  ]]]]]]]]]]]]]]]]]]]]]]]]]]" << C_RES << std::endl;
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "push_back" << "  --------------------------" << C_RES << std::endl;
	...
	print_vector_inf_ptr(&first);
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "erase 1/2" << "  --------------------------" << C_RES << std::endl;
	first.erase(it1, it2);
	print_vector_inf_ptr(&first);
	first.erase(first.begin(), first.begin() + 1);
	print_vector_inf_ptr(&first);
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "erase 2/2" << "  --------------------------" << C_RES << std::endl;
	first.erase(first.begin() + 3);
	print_vector_inf_ptr(&first);
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "pop_back" << "  --------------------------" << C_RES << std::endl;
	for (int i = 3; i < 6; i++)
		second.push_back(strs[i]);
	print_vector_inf_ptr(&second);
	second.pop_back();
	print_vector_inf_ptr(&second);
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "swap" << "  --------------------------" << C_RES << std::endl;
	std::cout << SKY_BLUE << "------------- " << "AVANT SWAP" << " -------------" << C_RES << std::endl;
	print_vector_inf_ptr(&first);
	print_vector_inf_ptr(&second);
	first.swap(second);
	std::cout << SKY_BLUE << "------------- " << "APRES SWAP" << " -------------" << C_RES << std::endl;
	print_vector_inf_ptr(&first);
	print_vector_inf_ptr(&second);
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "assign 1/2" << "  --------------------------" << C_RES << std::endl;
	NS::vector<std::string> fourth;
	fourth.assign(6, "twelve"); // n, val
	print_vector_inf_ptr(&fourth);
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "assign 2/2" << "  --------------------------" << C_RES << std::endl;
	fourth.assign(first.begin() + 2, first.begin() + 6); // range
	print_vector_inf_ptr(&fourth);
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "insert 1/3" << "  --------------------------" << C_RES << std::endl;
	print_vector_inf_ptr(&fourth);
	fourth.insert(fourth.begin() + 2, "ninety-nine"); // pos, val
	print_vector_inf_ptr(&fourth);
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "insert 2/3" << "  --------------------------" << C_RES << std::endl;
	fourth.insert(fourth.begin() + 3, 3, "eight"); // pos, n, val
	print_vector_inf_ptr(&fourth);
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "insert 3/3" << "  --------------------------" << C_RES << std::endl;
	fourth.insert(fourth.begin() + 3, first.begin() + 2, first.begin() + 5); // range
	print_vector_inf_ptr(&fourth);
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "clear" << "  --------------------------" << C_RES << std::endl;
	first.clear();
	print_vector_inf_ptr(&first);
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "swap after clear" << "  --------------------------" << C_RES << std::endl;
	std::cout << SKY_BLUE << "------------- " << "AVANT SWAP" << " -------------" << C_RES << std::endl;
	print_vector_inf_ptr(&first);
	print_vector_inf_ptr(&second);
	first.swap(second);
	...
	print_vector_inf_ptr(&first);
	print_vector_inf_ptr(&second);
  std::cout << SKY_BLUE << "[[[[[[[[[[[[[[[[[[[[[[[[[[  " << std::left << std::setw(SW) << "ELEMENT ACCESS" << "  ]]]]]]]]]]]]]]]]]]]]]]]]]]" << C_RES << std::endl;
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "at" << "  --------------------------" << C_RES << std::endl;
	...
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "front" << "  --------------------------" << C_RES << std::endl;
	std::cout << first.front() << std::endl;
	std::cout << second.front() << std::endl;
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "back" << "  --------------------------" << C_RES << std::endl;
	std::cout << first.back() << std::endl;
	// std::cout << second.back() << std::endl;  // valgrind
	// std::cout << first.at(9) << std::endl; // exception	return (0);
	std::cout << SKY_BLUE << "[[[[[[[[[[[[[[[[[[[[[[[[[[  " << std::left << std::setw(SW) << "ALLOCATOR" << "  ]]]]]]]]]]]]]]]]]]]]]]]]]]" << C_RES << std::endl;
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "get_allocator" << "  --------------------------" << C_RES << std::endl;
  ...
  for (i = 0; i < 5; i++) myvector.get_allocator().construct(&p[i],strs[i]);
  ...
  myvector.get_allocator().deallocate(p,5);
	std::cout << SKY_BLUE << "[[[[[[[[[[[[[[[[[[[[[[[[[[  " << std::left << std::setw(SW) << "CAPACITY" << "  ]]]]]]]]]]]]]]]]]]]]]]]]]]" << C_RES << std::endl;
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "max_size" << "  --------------------------" << C_RES << std::endl;
	...
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "resize" << "  --------------------------" << C_RES << std::endl;
	print_vector_inf_ptr(&fourth);
	fourth.resize(15);
	print_vector_inf_ptr(&fourth);
	fourth.resize(6);
	...
	fourth.resize(8);
	print_vector_inf_ptr(&fourth);
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "reserve" << "  --------------------------" << C_RES << std::endl;
	print_vector_inf_ptr(&first);
  first.reserve(13);
  print_vector_inf_ptr(&first);
	first.reserve(79);
  ...
  std::cout << SKY_BLUE << "[[[[[[[[[[[[[[[[[[[[[[[[[[  " << std::left << std::setw(SW) << "ITERATORS" << "  ]]]]]]]]]]]]]]]]]]]]]]]]]]" << C_RES << std::endl;
	...
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "const reverse" << "  --------------------------" << C_RES << std::endl;
	print_vector(&first);
	rprint_vector(&first);
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "const iterators" << "  --------------------------" << C_RES << std::endl;
	{
	...
	std::cout << SKY_BLUE << "[[[[[[[[[[[[[[[[[[[[[[[[[[  " << std::left << std::setw(SW) << "NON-MEMBER" << "  ]]]]]]]]]]]]]]]]]]]]]]]]]]" << C_RES << std::endl;
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "swap" << "  --------------------------" << C_RES << std::endl;
	{
	...
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "relational ==" << "  --------------------------" << C_RES << std::endl;
	std::cout << (first == second) << " ";
	std::cout << (second == second) << " ";
	...
	std::cout << (second >= second) << " ";
	std::cout << (second >= first) << std::endl;
  std::cout << SKY_BLUE << "[[[[[[[[[[[[[[[[[[[[[[[[[[  " << std::left << std::setw(SW) << "ITERATORS SWAP" << "  ]]]]]]]]]]]]]]]]]]]]]]]]]]" << C_RES << std::endl;
...
void	test_vector(void)
{
	...
	print_vector_inf_ptr(&first);
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "constructor 2/4 (fill)" << "  --------------------------" << C_RES << std::endl;
	NS::vector<int> second (4,100);                       // n, val (fill)
	print_vector_inf_ptr(&second);
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "constructor 3/4 (range)" << "  --------------------------" << C_RES << std::endl;
	NS::vector<int> fifth (second.begin() + 1,second.end());  // range
	print_vector_inf_ptr(&fifth);
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "constructor 4/4 (copy)" << "  --------------------------" << C_RES << std::endl;
	NS::vector<int> third(second);                       // copy
	print_vector_inf_ptr(&third);
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "operator=" << "  --------------------------" << C_RES << std::endl;
...
void test_map(void)
{
  ...
  std::cout << SKY_BLUE << "[[[[[[[[[[[[[[[[[[[[[[[[[[  " << std::left << std::setw(SW) << "BASICS" << "  ]]]]]]]]]]]]]]]]]]]]]]]]]]" << C_RES << std::endl;
	std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "constructor 1/3" << "  --------------------------" << C_RES << std::endl;
  map_type map_1;
  ...
  print_map(map_1);
  std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "constructor 2/3" << "  --------------------------" << C_RES << std::endl;
  map_type map_cpy(map_1);
  print_map(map_cpy);
  std::cout << "erase (key) : " << map_cpy.erase(pair1.first) << std::endl;
  print_map(map_1);
  print_map(map_cpy);
  std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "constructor 3/3" << "  --------------------------" << C_RES << std::endl;
  ...
  std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "erase 1/3" << "  --------------------------" << C_RES << std::endl;
  map_type::iterator it = map_1.begin();
  std::cout << (*it).first << " : " << (*it).second << std::endl;
  map_1.erase(0);
  print_map(map_1);
  std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "erase 2/3" << "  --------------------------" << C_RES << std::endl;
  map_1.erase(map_1.begin());
  // map_1.erase(map_1.end()); // segfault w/ std
  // map_1.erase(map_type::iterator(NULL)); // segfault w/ std
  print_map(map_1);
  std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "erase 3/3" << "  --------------------------" << C_RES << std::endl;
  ...
  for (; rit != rit_end; rit++)
    std::cout << YELLOW << rit->first << " => " << rit->second << C_RES << std::endl;
  std::cout << SKY_BLUE << "[[[[[[[[[[[[[[[[[[[[[[[[[[  " << std::left << std::setw(SW) << "OPERATIONS" << "  ]]]]]]]]]]]]]]]]]]]]]]]]]]" << C_RES << std::endl;
  std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "find" << "  --------------------------" << C_RES << std::endl;
  std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "count" << "  --------------------------" << C_RES << std::endl;
  std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "lower_bound" << "  --------------------------" << C_RES << std::endl;
  ...
  std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "upper_bound" << "  --------------------------" << C_RES << std::endl;
  ...
  std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "equal_range" << "  --------------------------" << C_RES << std::endl;
  ...
  std::cout << (map_empty >= map_empty) << std::endl;
  std::cout << (map_empty >= map_1) << std::endl;
  std::cout << SKY_BLUE << "--------------------------  " << std::left << std::setw(SW) << "all operators" << "  --------------------------" << C_RES << std::endl;
  {
  ...
  std::cout << SKY_BLUE << "[[[[[[[[[[[[[[[[[[[[[[[[[[  " << std::left << std::setw(SW) << "REVERSE ITERATOR" << "  ]]]]]]]]]]]]]]]]]]]]]]]]]]" << C_RES << std::endl;
  print_map(map_full);
  rprint_map(map_full);
  std::cout << SKY_BLUE << "[[[[[[[[[[[[[[[[[[[[[[[[[[  " << std::left << std::setw(SW) << "get_allocator" << "  ]]]]]]]]]]]]]]]]]]]]]]]]]]" << C_RES << std::endl;
  {
  ...
  std::cout << SKY_BLUE << "[[[[[[[[[[[[[[[[[[[[[[[[[[  " << std::left << std::setw(SW) << "COMPARE FUNCTION" << "  ]]]]]]]]]]]]]]]]]]]]]]]]]]" << C_RES << std::endl;
  ...
  std::cout << SKY_BLUE << "[[[[[[[[[[[[[[[[[[[[[[[[[[  " << std::left << std::setw(SW) << "ITERATOR SWAP" << "  ]]]]]]]]]]]]]]]]]]]]]]]]]]" << C_RES << std::endl;
  print_map(map_1);
  ...
  std::cout << "Value : " << it_test->second << std::endl;
  print_map(map_1);
  std::cout << SKY_BLUE << "[[[[[[[[[[[[[[[[[[[[[[[[[[  " << std::left << std::setw(SW) << "ITERATOR INSERT" << "  ]]]]]]]]]]]]]]]]]]]]]]]]]]" << C_RES << std::endl;
  ...
  std::cout << "Value : " << it_test->second << std::endl;
  print_map(map_1);
  std::cout << SKY_BLUE << "[[[[[[[[[[[[[[[[[[[[[[[[[[  " << std::left << std::setw(SW) << "ITERATOR DELETE" << "  ]]]]]]]]]]]]]]]]]]]]]]]]]]" << C_RES << std::endl;
  map_1.erase(5);
