...
namespace ft
{
    ...
    class const_tree_iterator : public std::bidirectional_iterator_tag
    {
        ...
        public:
            ...
            inline const_tree_iterator() : _node(NULL) {};
            inline const_tree_iterator(const const_tree_iterator<T> &it) : _node(it.base()) {};
            inline const_tree_iterator(const tree_iterator<T> &it) : _node(it.base()) {};
            inline const_tree_iterator(node_pointer node) : _node(node) {};
